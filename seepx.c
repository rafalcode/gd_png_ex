/*- seepx wholesale copy of pngpixel.
 *
...
static unsigned component(png_const_bytep row, png_uint_32 x, unsigned c, unsigned bit_depth, unsigned channels)
{
   ...
   switch (bit_depth)
   {
      ...
      default:
          ...
          * libpng itself:
          */
         fprintf(stderr, "seepx: invalid bit depth %u\n", bit_depth);
         exit(1);
   }
}
...
static void print_pixel(png_structp png_ptr, png_infop info_ptr, png_const_bytep row, png_uint_32 x)
{
   ...
   switch (png_get_color_type(png_ptr, info_ptr)) {
      ...
      default:
         png_error(png_ptr, "seepx: invalid color type");
   }
}
   ...
   if (argc == 4) {
      ...
      if (f != NULL)
      {
         ...
         if (png_ptr != NULL) {
            ...
            if (info_ptr != NULL) {
               /* Declare stack variables to hold pointers to locally allocated data.  */
               ...
               if (setjmp(png_jmpbuf(png_ptr)) == 0) {
                     ...
                     &compression_method, &filter_method))
                  {
                     ...
                     switch (interlace_method) {
                        ...
                        default:
                           png_error(png_ptr, "seepx: unknown interlace");
                     }
                  ...
                  pass_loop_end:
                     ...
                     png_error(png_ptr, "seepx: png_get_IHDR failed");
               ...
               fprintf(stderr, "seepx: out of memory allocating png_info\n");

            png_destroy_read_struct(&png_ptr, NULL, NULL);
         }

         else
            fprintf(stderr, "seepx: out of memory allocating png_struct\n");
      }

      else
         fprintf(stderr, "seepx: %s: could not open file\n", argv[3]);
   }

   else
      /* Wrong number of arguments */
      fprintf(stderr, "seepx: usage: seepx x y png-file\n");
